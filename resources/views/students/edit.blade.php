                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <select name="rombel_id" class="form-control form-control-select">
                                ...
                                <option value="{{ $rombel->id }}" {{ $student->rombel_id == $rombel->id ? 'selected' : null }}>{{ $rombel->rombel }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <select name="rayon_id" class="form-control form-control-select">
                                ...
                                <option value="{{ $rayon->id }}" {{ $student->rayon_id == $rayon->id ? 'selected' : null }}>{{ $rayon->rayon }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
